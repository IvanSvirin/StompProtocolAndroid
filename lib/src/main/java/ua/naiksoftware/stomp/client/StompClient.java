...
public class StompClient {
     ...
     */
    private void connect(List<StompHeader> _headers) {
     ...
     * @param _headers might be null
     */
    private void connect(List<StompHeader> _headers, boolean reconnect) {
                ...
                .subscribe(lifecycleEvent -> {
                    switch (lifecycleEvent.getType()) {
                        case OPENED:
                            ...
                            mConnectionProvider.send(new StompMessage(StompCommand.CONNECT, headers, null)).subscribe();
                            break;
    ...
    public Observable<Void> send(StompMessage stompMessage) {
        Observable<Void> observable = mConnectionProvider.send(stompMessage);
        if (!mConnected) {
    ...
    private Observable<StompMessage> topic(String destinationPath, List<StompHeader> headerList) {
